...
export interface Bet1155Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface Bet1155 extends BaseContract {
  connect(runner?: ContractRunner | null): Bet1155;
  waitForDeployment(): Promise<this>;

  interface: Bet1155Interface;
  ...
  resolve: TypedContractMethod<
    [tokenId: BigNumberish, outcome: BigNumberish],
    [void],
    "nonpayable"
  >;

  result: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
